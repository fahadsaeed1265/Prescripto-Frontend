...
const Header = () => {
  return (
    <div className='flex flex-column md:flex-row flex-wrap bg-indigo-500 rounded-lg px-6 md:px-10 lg-px-20'>

    {/* left side */}
    
<div className=' md:w-1/2 flex flex-col items-start justify-center gap-4 py-10 md:my-[10vw] md:mb-[30px]'>
